    ...
    <Layout>
        ...
        <div class="jumbotron blue-gradient">
            <div class="text-white text-center pt-5 px-4">
                ...
                <h4 class="white-text my-4">This is a draft</h4>
            </div>
        </div>
        <main class="mt-5">
            <div class="container">
                <h2>Welcome to Kochii</h2>
                <p>These terms and conditions outline the rules and regulations for the use of Kochii's Website.</p> <br />
                <span style={{ textTransform: 'capitalize' }}> Kochii</span> is located at:<br />
                <address>Toronto <br />- Ontario , Canada<br />
                </address>
            ...
            capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
                ...
                <h2>Cookies</h2>
                <p>We employ the use of cookies. By using Kochii's website you consent to the use of cookies
            in accordance with Kochii's privacy policy.</p>
            ...
            affiliate / advertising partners may also use cookies.</p>
                ...
                <h2>License</h2>
                <p>Unless otherwise stated, Kochii and/or it's licensors own the intellectual property rights for
                all material on Kochii. All intellectual property rights are reserved. You may view and/or print
                pages from https://kochii.app for your own personal use subject to restrictions set in these terms
            and conditions.</p>
                <p>You must not:</p>
                <ol>
                    <li>Republish material from https://kochii.app</li>
                    <li>Sell, rent or sub-license material from https://kochii.app</li>
                    <li>Reproduce, duplicate or copy material from https://kochii.app</li>
                </ol>
                <p>Redistribute content from Kochii (unless content is specifically made for redistribution).</p>
                ...
                the visibility associated with the hyperlink outweighs the absence of Kochii; and (d) where the
            ...
            you must notify us by sending an e-mail to <a href="mailto:contact@kochii.app"
                        title="send an email to contact@kochii.app">contact@kochii.app</a>.
            ...
            and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
                ...
                <p>No use of Kochii's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
            ...
            we will not be liable for any loss or damage of any nature.</p>
                ...
                <h2 class="mb-3">Credit & Contact Information</h2>
                <p>This Terms and conditions page was created at <a style={{ color:'inherit', textDecoration: 'none', cursor: 'text' }}
                    href="https://termsandconditionstemplate.com/generate/">termsandconditionstemplate.com</a> generator. If
            you have
