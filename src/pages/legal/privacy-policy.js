...
const PrivacyPolicyPage = () => (
    <Layout>
        ...
        <main class="mt-5">
            <div class="container">
                <h2>Privacy Policy for Kochii</h2>
                <p>At Kochii, accessible from https://kochii.app, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
            Kochii and how we use it.</p>
            ...
            contact us.</p>
                ...
                regards to the information that they shared and/or collect in Kochii. This policy is not applicable to any
            ...
            company name, address, email address, and telephone number.</p>
                ...
                <h2>Log Files</h2>
                <p>Kochii follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a>
            and the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Online Privacy Policy
                Generator</a>.</p>


                <h2>Cookies and Web Beacons</h2>
                <p>Like any other website, Kochii uses 'cookies'. These cookies are used to store information including
            ...
            and/or other information.</p>
                ...
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Kochii.</p>
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Kochii, which are sent directly to users'
            ...
            on websites that you visit.</p>
                <p>Note that Kochii has no access to or control over these cookies that are used by third-party advertisers.</p>


                <h2>Third Party Privacy Policies</h2>
                <p>Kochii's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
            ...
            and guardians to observe, participate in, and/or monitor and guide their online activity.</p>
                <p>Kochii does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
