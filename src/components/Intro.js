              ...
              <div class="row d-flex justify-content-center text-center">
                <div class="col-md-10">
                  ...
                  <h4 class="white-text my-4">
                    Kochii assists and encourages individuals for a manageable
          ...
          <section id="features" class="text-center">
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-1">
                ...
                <p class="grey-text">
                  Receive real-time up to date notifications regarding the
                  status of your inventory with a quick glance.
                </p>
              </div>
              <div class="col-md-4 mb-1">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-12 mb-4">
                <div class="view overlay z-depth-1-half">
                  <img
                    alt="Recipe website opened on a Mac laptop screen"
                    src={"/annie-spratt-f4gQ-dJ0yo8-unsplash.jpg"}
                    class="img-fluid"
                    loading="lazy"
                  />
                  <a href="#!">
              ...
              <div class="col-lg-4 col-md-6 mb-4">
                <div class="view overlay z-depth-1-half">
                  <img
                    alt="Bicycle rider's Perspective with Bags of Groceries"
                    src={"/boxed-water-is-better-6WrKKQcEnXk-unsplash.jpg"}
                    class="img-fluid"
                    loading="lazy"
                  />
                  <a href="#!">
                ...
                <p class="grey-text">
                  The built-in grocery list feature will alert you when adding
                  existing ingredients to buy for your upcoming grocery
                  shopping.
                </p>
              </div>
              <div class="col-lg-4 col-md-6 mb-4">
                <div class="view overlay z-depth-1-half">
                  <img
                    alt="Tabletop Plant in Clear Vase with Coins instead of Soil"
                ...
                <p class="grey-text">
                  You will be notified when a product's expiration date is near.
                  Use them before they go bad. Do not let the money you've spent
                  go to waste.
                </p>
              </div>
            </div>
          ...
          <section id="blog">
            ...
            <div class="row">
                ...
                >
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                      <img
                        alt="Young lady in a Fitness Outfit Preparing a Drink"
                        class="d-block w-100"
                        src={"/lyfe-fuel-4wtxPhvQZds-unsplash.jpg"}
                        loading="lazy"
                      />
                    </div>
              ...
              <div class="col-md-6">
                ...
                <h4 class="mb-3">
                  <strong>This is a placeholder blog</strong>
                </h4>
                <p>
